                    ...
                    <div className='w-100 d-flex flex-column align-items-center'>
                                <div className='formdata'>
                                    <Row className='d-flex justify-content-between '>
                                        ...
                                        <input className='mt-1 p-1 shadows inwidth' type="text" name='JobWorkDescription' required value={formData.JobWorkDescription} onChange={getinput}  />
                                    </Col>
                                    </Row>
                                </div>
                            ...
                            <div className='formdata'>
                                <Row className='d-flex justify-content-between'>
                                    ...
                                    <Col lg={5} xs={12} className='d-flex flex-column mt-4'>
                                        <h>Quantity</h>
                                        <input className='mt-1 p-1 shadows inwidth' type="text" name='Quantity' required value={formData.Quantity} onChange={getinput}  />
                                    </Col>
                                    <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
