                ...
                <Container fluid>
                    ...
                    <form onSubmit={handleFormSubmit}>
                        <div className='w-100 d-flex flex-column align-items-center'>
                            ...
                            <div className='formdata'>
                                <Row className='d-flex justify-content-between'>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4'><h>Reservation Date</h><p className='mt-1 p-1 shadows inwidth' >{formData.Reservationdate}</p></Col>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'><h>Start Time</h><p className='mt-1 p-1 shadows inwidth' >{formData.Starttime}</p></Col>
                               
                                </Row>
                            </div>
                            <div className='formdata'>
                                <Row className='d-flex justify-content-between'>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'><h>End Time</h><p className='mt-1 p-1 shadows inwidth' >{formData.Endtime}</p></Col>
