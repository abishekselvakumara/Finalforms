                    ...
                    <form onSubmit={handleFormSubmit} className='w-100 d-flex flex-column align-items-center formscroll' >
                        <div className='formdata'>
                            <Row className='d-flex justify-content-between'>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
                                    <h>Alumini Name</h>
                                    <input className='mt-1 p-1 shadows inwidth' name='AluminiName' required value={formData.AluminiName} onChange={getinput} />
                                </Col>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
                                    <h>Date of Birth</h>
                        ...
                        <div className='formdata'>
                            <Row className='d-flex justify-content-Start'>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4 padding'>
                                    <h>Address</h>
                                    <textarea className='mt-1 p-1 shadows inwidth' rows="4" Name='Address' required value={formData.Address} onChange={getinput} />
                                </Col>
                                </Row>
                                </div>
