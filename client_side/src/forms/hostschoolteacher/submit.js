                    ...
                    <form onSubmit={handleFormSubmit} className='w-100 d-flex flex-column align-items-center'>
                        <div className='formdata'>
                            <Row className='d-flex justify-content-between'>
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4'><h>Teacher Name</h><p className='mt-1 p-1 shadows inwidth' >{formData.TeacherName}</p></Col>
                        ...
                        <div className='formdata'>
                            <Row className='d-flex justify-content-between'>
                                ...
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4'><h>Teacher ID</h><p className='mt-1 p-1 shadows inwidth' >{formData.TeacherID}</p></Col>
                            </Row>
                        </div>
                        <div className='formdata'>
                            <Row className='d-flex justify-content-between'>
                                ...
                                <Col lg={5} xs={12} className='d-flex flex-column mt-4'><h>UDISE Code</h><p className='mt-1 p-1 shadows inwidth' >{formData.UDISECode}</p></Col>
                            </Row>
                        </div>
